...
const OmanLanding = () => {
  ...
  const advantages = [
    ...
    { icon: Users, title: "Dedicated Multilingual Liaison", desc: "Arabic-speaking translators and culturally-aware coordinators throughout your journey" },
    { icon: Award, title: "40+ Years Excellence", desc: "Trusted expertise and world-class surgical outcomes" },
  ];

  const procedures = [
    { title: "Premium Cataract Surgery", desc: "Advanced IOL options with stitchless micro-incision for quick visual recovery" },
    { title: "Diabetic & Retinal Care", desc: "Laser therapy, anti-VEGF injections, and advanced vitrectomy surgeries" },
    { title: "Glaucoma Management", desc: "Precision diagnostics and advanced surgical interventions" },
    { title: "LASIK & Custom Refractive", desc: "Blade-free technology for high refractive errors and thin corneas" },
  ];

  const steps = [
    { number: "01", title: "Digital Consultation", desc: "Share optical scans via WhatsApp for assessment" },
    { number: "02", title: "Medical Visa Invitation", desc: "Swift processing through Indian Embassy in Muscat" },
  ...
  const faqs = [
    ...
    {
      q: "Can you arrange flights from Muscat?",
      a: "Yes, our team coordinates direct flights from Muscat International Airport to Bangalore."
    },
    {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Premium, affordable eye surgery in Bangalore, India for patients from Oman (Muscat, Salalah). Advanced Cataract, LASIK, and Retinal care at Vijaya Eye Clinic. Fast medical visa invite." />
        <meta name="keywords" content="best eye hospital in bangalore for omani patients, advanced eye surgery in india from muscat, cataract surgery bangalore vijaya eye clinic, premium lasik cost india oman" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        <section className="relative min-h-[600px] flex items-center justify-center bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Premium Eye Care for Patients from Oman</h1>
            <p className="text-lg md:text-xl text-blue-100 mb-8">From Muscat, Salalah, and across Oman seeking advanced vision restoration.</p>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-700">Our facilities in <strong>Vijayanagar</strong> and <strong>Nagadevanahalli</strong> offer world-class eye care with specialized support for Omani patients.</p>
          </div>
        </section>

        <section className="py-16 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Why Omani Patients Choose Vijaya Eye Clinic</h2>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Your Journey from Oman</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {steps.map((step, idx) => (
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-100 mb-8">Join Omani patients for world-class vision restoration.</p>
