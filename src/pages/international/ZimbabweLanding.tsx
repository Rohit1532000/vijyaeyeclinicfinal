  ...
  "@graph": [
    {
      ...
      "alternateName": [
        "Affordable Eye Surgery in Bangalore for Zimbabwe Patients",
        "Best Eye Hospital in India for Zimbabwe Patients",
        "Top Eye Hospital for Zimbabwean Patients"
      ],
      "url": "https://vijayaeyeclinic.com/international/zimbabwe",
      "image": "https://vijayaeyeclinic.com/logo.png",
      "telephone": "+91-9739302523",
      "email": "care@vijayaeyeclinic.com",
      "priceRange": "$$",
      "description": "Vijaya Eye Clinic is a premier super specialty eye hospital in Bangalore, India providing advanced cataract surgery, LASIK, retina vitrectomy, cornea transplant, glaucoma management, pediatric ophthalmology, squint realignment, and oculoplasty for international patients from Zimbabwe (Harare, Bulawayo, Chitungwiza, Mutare, Gweru).",
      "address": {
        "@type": "PostalAddress",
      ...
      "availableLanguage": ["English", "Shona Assistance", "Ndebele Assistance", "Hindi"]
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is the cataract surgery cost bangalore and vitrectomy surgery price india for Zimbabwe patients?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Surgical packages at Vijaya Eye Clinic are transparently bundled in USD/INR, providing 60% to 75% savings compared to private regional healthcare in Southern Africa. Cataract surgeries feature imported US-FDA approved Zeiss and Alcon IOLs, while 23G/25G vitrectomies cover endo-laser and comprehensive follow-ups."
          }
        },
        {
          "@type": "Question",
          "name": "How does Vijaya Eye Clinic assist with Indian Medical Visa paperwork in Harare?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Upon reviewing your optical reports and passport copies via WhatsApp or email, our international desk prepares an official hospital Medical Visa Invitation Letter within 24 hours for fast-track processing through the Embassy of India in Harare."
          }
        },
        {
          "@type": "Question",
          "name": "What is the typical stay duration in Bangalore?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, both our Vijayanagar and Nagadevanahalli centers are surrounded by vetted, comfortable serviced apartments equipped with private kitchens, allowing Zimbabwean families to prepare familiar meals during their recovery."
          }
        }
      ]
    }
...
const ZimbabweLanding = () => {
  ...
  const advantages = [
    {
      icon: TrendingUp,
      title: "High-Success Diabetic & Retinal Care",
      desc: "Advanced 23G/25G sutureless vitrectomy, anti-VEGF injections, and specialized endo-lasers for complex retinal detachments and diabetic retinopathy."
    },
    {
      icon: Shield,
      title: "Affordable Structured Packages",
      desc: "US-FDA approved equipment and global IOLs at 60% to 75% savings, with transparent USD/INR pricing protecting against exchange volatility."
    },
    {
      icon: Users,
      title: "Full Concierge & Travel Desk",
      desc: "Dedicated personal liaisons managing Harare embassy visa letters, Kempegowda Airport reception, local SIM cards, and serviced apartments."
    },
    {
      icon: Award,
  ...
  const treatmentSpecialities = [
    {
      icon: Eye,
      title: "Cataract Surgery in Bangalore for Zimbabwean Patients",
      desc: "Micro-Incision Cataract Surgery (MICS) with cold-ultrasound phacoemulsification and imported Toric, Multifocal, and Trifocal IOL implants from Alcon and Zeiss.",
      tag: "Daycare | 15 Mins"
    },
    {
      icon: Sparkles,
      title: "LASIK Surgery in Bangalore for Zimbabwean Patients",
    ...
    {
      icon: Activity,
      title: "Retina Treatment in Bangalore for Zimbabwean Patients",
      desc: "Vitrectomy surgery price india packages for diabetic traction, vitreous hemorrhage, and time-sensitive retinal tear repair using 23G/25G technology.",
      tag: "Retina Specialist"
    },
    {
      icon: Layers,
      title: "Glaucoma Treatment in Bangalore for Zimbabwean Patients",
    ...
    {
      icon: Shield,
      title: "Cornea Treatment in Bangalore for Zimbabwean Patients",
    ...
    {
      icon: Baby,
      title: "Pediatric Ophthalmology in Bangalore for Zimbabwean Patients",
    ...
    {
      icon: Smile,
      title: "Squint Eye Treatment in Bangalore for Zimbabwean Patients",
    ...
    {
      icon: Scissors,
      title: "Oculoplasty Treatment in Bangalore for Zimbabwean Patients",
  ...
  const steps = [
    {
      ...
      desc: "Submit your optical scans, OCT images, or doctor reports from Harare or Bulawayo via WhatsApp (+91 9739302523) for an expert evaluation and quote."
    },
    {
      number: "02",
      title: "Medical Visa (V-Visa) Letter",
      desc: "Receive an official hospital Medical Visa Invitation Letter within 24 hours to support expedited visa processing at the Embassy of India in Harare."
    },
    {
      number: "03",
    ...
    },
    {
      ...
      desc: "Undergo painless daycare microsurgery, receive a fit-to-fly certificate, and continue post-op virtual tele-consultations back home in Zimbabwe."
    }
  ];
  ...
  const faqs = [
    {
      ...
      a: "Simple procedures like blade-free LASIK or stitchless cataract surgery need 4 to 6 days. Complex vitrectomies, ocular trauma repairs, or corneal transplants require 7 to 14 days including follow-ups, scheduled around your return flight to Harare or Bulawayo."
    },
    {
      q: "Do you facilitate flights from Robert Gabriel Mugabe International Airport?",
      a: "Yes, our team coordinates flight reception connecting from Robert Gabriel Mugabe International Airport (HRE) in Harare to Bangalore (BLR) and arranges seamless airport pickup and local transit."
    },
    {
      q: "What are the payment options for Zimbabwean patients?",
      a: "We accept international credit cards, bank wire transfers, and foreign currency exchange. All quotes are transparently structured in USD or INR to protect against local currency fluctuations."
    },
    {
      q: "Is accommodation included with surgery packages?",
      a: "We connect you with vetted partner serviced apartments near our Vijayanagar and Nagadevanahalli centers equipped with private kitchens, allowing families to prepare familiar meals."
    },
    {
      q: "What follow-up support do I get after returning to Zimbabwe?",
      a: "We provide structured tele-health connectivity through scheduled virtual consultations over WhatsApp or Zoom, sharing optical notes directly with your eye doctor in Zimbabwe."
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Affordable Eye Surgery in Bangalore for Zimbabwe Patients | Vijaya Eye Clinic</title>
        <meta
          name="description"
          content="Restore your vision with advanced Cataract, Glaucoma, and Retina care at Vijaya Eye Clinic, Bangalore, India. Best eye hospital in India for Zimbabwe patients with visa support."
        />
        {/* Combined Keywords: Original + All 8 Core Procedures */}
        <meta
          name="keywords"
          content="best eye hospital in india for zimbabwe patients, cataract surgery cost bangalore, vitrectomy surgery price india, cataract surgery in bangalore for zimbabwean patients, lasik surgery in bangalore for zimbabwean patients, retina treatment in bangalore for zimbabwean patients, cornea treatment in bangalore for zimbabwean patients, glaucoma treatment in bangalore for zimbabwean patients, pediatric ophthalmology in bangalore for zimbabwean patients, squint eye treatment in bangalore for zimbabwean patients, oculoplasty treatment in bangalore for zimbabwean patients"
        />

        {/* Canonical Link */}
        <link rel="canonical" href="https://vijayaeyeclinic.com/international/zimbabwe" />

        {/* 2-Way Cross-Referenced International Hreflangs */}
        <link rel="alternate" hrefLang="en-ZW" href="https://vijayaeyeclinic.com/international/zimbabwe" />
        ...
        <link rel="alternate" hrefLang="en-YE" href="https://vijayaeyeclinic.com/international/yemen" />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <section className="relative min-h-[640px] flex items-center justify-center bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 bg-blue-500/20 text-blue-300 text-sm font-semibold px-4 py-1.5 rounded-full mb-6 border border-blue-400/30">
              <Plane className="w-4 h-4" /> Zimbabwe to Bangalore Medical Care Concierge
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Advanced Eye Care in Bangalore for Zimbabwe Patients
            </h1>
            <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
              Facing sub-specialty wait times in <strong>Harare or Bulawayo</strong>? Vijaya Eye Clinic provides world-class vitreoretinal care, blade-free LASIK, and micro-incision cataract surgery with complete visa assistance.
            </p>
        ...
        <section className="py-14 px-4 bg-white border-b border-slate-100">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-700 leading-relaxed text-base md:text-lg">
              Operating two super-specialty hubs in Bangalore—our central flagship center in <strong>Vijayanagar</strong> and our ring-road center in <strong>Nagadevanahalli</strong>—we combine internationally trained surgeons with top-tier Western technology for elite-level vision restoration at 60% to 75% cost savings compared to private regional healthcare.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2">
                Specialized Eye Treatments for Zimbabwean Patients
              </h2>
        ...
        {/* Why Patients from Zimbabwe Choose Us */}
        <section className="py-20 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2">
                Why Zimbabwean Patients Travel to Vijaya Eye Clinic
              </h2>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-50 to-blue-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2">
                Travel Facilitation from Zimbabwe to Bangalore
              </h2>
            </div>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-blue-50/80 p-8 rounded-2xl border border-blue-200">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Dedicated Hospitality for Zimbabwean Families</h3>
          ...
          <div className="container mx-auto max-w-3xl">
            <div className="text-center mb-14">
              ...
              <p className="text-slate-600">
                Essential travel and treatment details for Zimbabwean residents planning eye care in Bangalore.
              </p>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
              Send your prescription and optical reports from Harare, Bulawayo, or Mutare for an expert surgical evaluation, doctor recommendation, and transparent quote.
            </p>
            ...
            <div className="bg-blue-800/60 border border-blue-400/30 p-8 rounded-2xl">
              <h3 className="text-xl font-bold mb-6">Zimbabwe Patient Coordination Desk</h3>
