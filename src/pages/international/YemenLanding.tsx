...
const YemenLanding = () => {
  ...
  const advantages = [
    ...
    { icon: Shield, title: "Exceptional Value & Quality", desc: "Premium equipment from top global standards at accessible pricing" },
    { icon: Users, title: "Dedicated Multilingual Liaison", desc: "Arabic-speaking coordinators for complete support" },
    { icon: Award, title: "40+ Years Excellence", desc: "Trusted expertise with proven outcomes" },
  ];
  ...
  const steps = [
    ...
    { number: "02", title: "Medical Visa Invitation", desc: "Swift processing for Yemeni citizens" },
  ...
  const faqs = [
    ...
    {
      q: "Can you arrange flights from Sana'a or Aden?",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Premium, world-class eye surgery in Bangalore, India for patients from Yemen (Sana'a, Aden, Taiz). Advanced Cataract, LASIK, and Retinal care at Vijaya Eye Clinic. Get a medical visa invite." />
        <meta name="keywords" content="best eye hospital in bangalore for yemeni patients, advanced eye surgery in india from yemen, cataract surgery bangalore vijaya eye clinic, premium lasik cost india yemen" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        <section className="relative min-h-[600px] flex items-center justify-center bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Premium Eye Care for Patients from Yemen</h1>
            <p className="text-lg md:text-xl text-blue-100 mb-8">From Sana'a, Aden, Taiz seeking vision restoration.</p>
        ...
        <section className="py-16 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Why Yemeni Patients Choose Vijaya Eye Clinic</h2>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Your Journey from Yemen</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {steps.map((step, idx) => (
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-100 mb-8">Join Yemeni patients for vision restoration.</p>
