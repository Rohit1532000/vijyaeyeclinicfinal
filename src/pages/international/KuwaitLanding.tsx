...
const KuwaitLanding = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Best Eye Hospital in Bangalore for Kuwaiti Patients | Vijaya Eye Clinic</title>
        <meta name="description" content="Premium, world-class eye surgery in Bangalore, India for patients from Kuwait. Advanced Cataract, LASIK, and Retinal care at Vijaya Eye Clinic. Get a rapid medical visa invite." />
