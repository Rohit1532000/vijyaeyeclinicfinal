  ...
  "@graph": [
    {
      ...
      "alternateName": [
        "Best Eye Hospital in Bangalore for Indonesian Patients",
        "Top Eye Hospital for Indonesia Patients in India",
        "Advanced eye surgery in india from jakarta"
      ],
      ...
      "priceRange": "$$",
      "description": "Vijaya Eye Clinic is a leading super speciality eye hospital in Bangalore, India providing advanced cataract, LASIK, retina, glaucoma, cornea, pediatric ophthalmology, squint, and oculoplasty treatments for international patients from Indonesia (Jakarta, Surabaya, Medan, Bandung).",
      "address": {
        "@type": "PostalAddress",
      ...
      "availableLanguage": ["English", "Indonesian Assistance", "Hindi"]
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Why do patients from Indonesia choose cataract surgery bangalore vijaya eye clinic?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Indonesian patients from Jakarta and Surabaya select Vijaya Eye Clinic for stitchless micro-incision phacoemulsification, imported Zeiss and Alcon multifocal/toric lenses, and complete procedural transparency at 60% to 75% lower costs than private regional medical centers."
          }
        },
        {
          "@type": "Question",
          "name": "How does Vijaya Eye Clinic assist with Indian Medical Visas in Jakarta or Medan?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Upon reviewing your optical records and scan reports via WhatsApp or email, our international desk prepares an official hospital Medical Visa Invitation Letter within 24 hours for expedited processing with the Embassy of India in Jakarta or the Consulate General in Medan."
          }
        },
        {
          "@type": "Question",
          "name": "How long should a patient from Indonesia plan to stay in Bangalore?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "For blade-free LASIK or micro-incision cataract surgery, a 4 to 6 day stay is sufficient. Complex vitreoretinal procedures or corneal transplants may require 10 to 14 days before fit-to-fly clearance is issued."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, both our Vijayanagar and Nagadevanahalli centers are surrounded by vetted, comfortable serviced apartments equipped with private kitchens, allowing Indonesian families to prepare familiar meals during recovery."
          }
        }
      ]
    }
...
const IndonesiaLanding = () => {
  ...
  const advantages = [
    {
      ...
      desc: "High-end micro-incision surgeries, premium German/US IOL implants, blade-free laser suites, and high-definition Spectral-OCT imaging."
    },
    {
      icon: Shield,
      title: "Exceptional Value & Quality",
      desc: "Premium equipment identical to top US/European clinics at 60% to 75% optimized pricing protected against currency fluctuations."
    },
    {
      icon: Users,
      title: "Frictionless Travel Logistics",
      desc: "International help desk managing direct embassy visa processing, serviced apartment bookings, local SIM cards, and airport transfers."
    },
    {
      icon: Award,
      title: "35+ Years Clinical Excellence",
  ...
  const treatmentSpecialities = [
    {
      icon: Eye,
      title: "Cataract Surgery in Bangalore for Indonesian Patients",
    ...
    {
      icon: Sparkles,
      title: "LASIK Surgery in Bangalore for Indonesian Patients",
    ...
    {
      icon: Activity,
      title: "Retina Treatment in Bangalore for Indonesian Patients",
    ...
    {
      icon: Layers,
      title: "Glaucoma Treatment in Bangalore for Indonesian Patients",
    ...
    {
      icon: Shield,
      title: "Cornea Treatment in Bangalore for Indonesian Patients",
    ...
    {
      icon: Baby,
      title: "Pediatric Ophthalmology in Bangalore for Indonesian Patients",
    ...
    {
      icon: Smile,
      title: "Squint Eye Treatment in Bangalore for Indonesian Patients",
    ...
    {
      icon: Scissors,
      title: "Oculoplasty Treatment in Bangalore for Indonesian Patients",
  ...
  const steps = [
    {
      ...
      desc: "Share optical scans or diagnostic files via WhatsApp (+91 9739302523) for immediate preliminary evaluation and cost estimation."
    },
    {
      number: "02",
      title: "Medical Visa (V-Visa) Letter",
      desc: "Fast-track Medical Visa Invitation Letter prepared within 24 hours for submission to the Indian Embassy in Jakarta or Medan."
    },
    {
      number: "03",
      title: "Airport Reception & Stay",
      desc: "Executive transit from Kempegowda International Airport (BLR) directly to verified partner serviced apartments."
    },
    {
      number: "04",
      title: "Treatment & Virtual Follow-up",
      desc: "Undergo advanced daycare microsurgery, receive a fit-to-fly certificate, and continue virtual follow-ups back in Indonesia."
    }
  ];
  ...
  const faqs = [
    {
      ...
      a: "Yes, an Indian Medical Visa (MED Visa) is required. We issue an official Medical Visa Invitation Letter on hospital letterhead within 24 hours for priority submission to the Indian Embassy in Jakarta or the Consulate General in Medan."
    },
    {
      q: "Can I get a cost estimate before I book my flights from Jakarta?",
      a: "Yes, absolutely. Send your optical scans or case documents via WhatsApp. Our senior specialists provide transparent, itemized cost estimates in USD or INR for accurate budgeting."
    },
    {
      q: "What types of surgeries do you specialize in at Vijaya Eye Clinic?",
      a: "We specialize in stitchless Micro-incision Cataract Surgery (Phacoemulsification) with premium IOLs, Topography-guided Contoura LASIK, Glaucoma shunts, 23G/25G Vitreoretinal surgery, and Corneal transplants."
    },
    {
      q: "Are language translators available at the hospital?",
      a: "Our clinical and administrative teams speak fluent English. We also assign a dedicated international patient coordinator to guide you smoothly through each clinical and diagnostic stage."
    },
    {
      q: "What kind of dietary and accommodation options are available near the clinic?",
      a: "We arrange bookings in vetted serviced apartments and hotels near our Vijayanagar and Nagadevanahalli centers featuring private kitchens, allowing you to prepare meals according to your preferences."
    },
    {
      q: "What happens if I require a follow-up once I return to Indonesia?",
      a: "We provide comprehensive post-discharge tele-health connectivity. You can schedule virtual reviews over Zoom or WhatsApp directly with your operating specialist to review your recovery progress."
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Best Eye Hospital in Bangalore for Indonesian patients from Jakarta & Surabaya. Advanced eye surgery in india from jakarta, cataract, LASIK, retina & cornea care with visa support."
        />
        {/* Combined Keywords: Original + All 8 Core Procedures */}
        <meta
          name="keywords"
          content="best eye hospital in bangalore for indonesian patients, advanced eye surgery in india from jakarta, cataract surgery bangalore vijaya eye clinic, premium lasik cost india indonesia, cataract surgery in bangalore for indonesian patients, lasik surgery in bangalore for indonesian patients, retina treatment in bangalore for indonesian patients, cornea treatment in bangalore for indonesian patients, glaucoma treatment in bangalore for indonesian patients, pediatric ophthalmology in bangalore for indonesian patients, squint eye treatment in bangalore for indonesian patients, oculoplasty treatment in bangalore for indonesian patients"
        />

        {/* Canonical Link */}
        <link rel="canonical" href="https://vijayaeyeclinic.com/international/indonesia" />
        ...
        <script type="application/ld+json">
          {JSON.stringify(indonesiaSchema)}
        </script>
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <section className="relative min-h-[640px] flex items-center justify-center bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 bg-blue-500/20 text-blue-300 text-sm font-semibold px-4 py-1.5 rounded-full mb-6 border border-blue-400/30">
              <Plane className="w-4 h-4" /> Indonesia to Bangalore Medical Care Concierge
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Best Eye Hospital in Bangalore for Indonesian Patients
            </h1>
            <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
              Seeking advanced eye surgery in india from jakarta, Surabaya, Medan, or Bandung? Vijaya Eye Clinic provides world-class surgical care, blade-free LASIK, and vitreoretinal treatments with comprehensive visa assistance.
            </p>
        ...
        <section className="py-14 px-4 bg-white border-b border-slate-100">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-700 leading-relaxed text-base md:text-lg">
              Every year, patients from Indonesia choose <strong>Vijaya Eye Clinic</strong> in Bangalore across our state-of-the-art super specialty facilities in <strong>Vijayanagar</strong> and <strong>Nagadevanahalli</strong>. With over 35 years of clinical trust, we deliver the same US-FDA approved technologies used in leading Western centers at predictable, cost-effective pricing.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2">
                Advanced Eye Treatments for Indonesian Patients
              </h2>
        ...
        {/* Why Patients from Indonesia Choose Us */}
        <section className="py-20 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2">
                Why Indonesian Patients Choose Vijaya Eye Clinic
              </h2>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-50 to-blue-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2">
                Your Journey from Indonesia to Bangalore
              </h2>
            </div>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-blue-50/80 p-8 rounded-2xl border border-blue-200">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Dedicated Hospitality for Indonesian Families</h3>
          ...
          <div className="container mx-auto max-w-3xl">
            <div className="text-center mb-14">
              ...
              <p className="text-slate-600">
                Essential travel and treatment details for Indonesian residents planning eye care in Bangalore.
              </p>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
              Send your prescription and optical reports from Jakarta, Surabaya, or Medan for an expert surgical evaluation, doctor recommendation, and transparent quote.
            </p>
            ...
            <div className="bg-blue-800/60 border border-blue-400/30 p-8 rounded-2xl">
              <h3 className="text-xl font-bold mb-6">Indonesia Patient Coordination Desk</h3>
