  ...
  "@graph": [
    {
      ...
      "alternateName": [
        "Best Eye Hospital in Bangalore for Filipino Patients",
        "Top Eye Hospital for Philippines Patients in India",
        "Advanced eye surgery in india from manila"
      ],
      "url": "https://vijayaeyeclinic.com/international/philippines",
      "image": "https://vijayaeyeclinic.com/logo.png",
      "telephone": "+91-9739302523",
      "email": "care@vijayaeyeclinic.com",
      "priceRange": "$$",
      "description": "Vijaya Eye Clinic is a leading super specialty eye hospital in Bangalore, India providing advanced cataract surgery, LASIK, retina vitrectomy, cornea transplant, glaucoma management, pediatric ophthalmology, squint realignment, and oculoplasty for international patients from the Philippines (Manila, Cebu, Davao, Quezon City).",
      "address": {
        "@type": "PostalAddress",
      ...
      "availableLanguage": ["English", "Tagalog Assistance", "Hindi"]
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How do I get an Indian Medical Visa from Manila?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Upon reviewing your optical scans and passport copies via WhatsApp or email, our international desk issues an official hospital Medical Visa Invitation Letter within 24 hours for priority processing with the Embassy of India in Manila."
          }
        },
        {
          "@type": "Question",
          "name": "What is the advantage of getting cataract surgery at Vijaya Eye Clinic?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Filipino patients receive stitchless micro-incision phacoemulsification with imported premium Zeiss and Alcon multifocal, trifocal, and toric IOL implants at 60% to 75% cost savings compared to private regional healthcare."
          }
        },
        {
          "@type": "Question",
          "name": "How long after undergoing advanced cataract surgery can I fly back to the Philippines?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Our sutureless micro-incision phacoemulsification technique enables rapid visual recovery. Most patients receive their formal fit-to-fly clearance certificate within 4 to 5 days after surgery."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, both our Vijayanagar and Nagadevanahalli centers are surrounded by vetted, comfortable serviced apartments equipped with private kitchens, allowing Filipino families to prepare familiar meals during recovery."
          }
        }
      ]
    }
...
const PhilippinesLanding = () => {
  ...
  const advantages = [
    {
      icon: TrendingUp,
      title: "Uncompromised Technology Suite",
      desc: "Micro-incision cataract surgeries, premium global IOL implants, blade-free laser suites, and high-definition Spectral OCT."
    },
    {
      icon: Shield,
      title: "Exceptional Quality & Price Optimization",
    ...
    {
      icon: Users,
      title: "Comprehensive Concierge Care",
      desc: "Dedicated personal liaisons managing Manila embassy visa letters, Kempegowda Airport reception, local SIM cards, and serviced apartments."
    },
    {
      icon: Award,
  ...
  const treatmentSpecialities = [
    {
      icon: Eye,
      title: "Cataract Surgery in Bangalore for Filipino Patients",
    ...
    {
      icon: Sparkles,
      title: "LASIK Surgery in Bangalore for Filipino Patients",
    ...
    {
      icon: Activity,
      title: "Retina Treatment in Bangalore for Filipino Patients",
    ...
    {
      icon: Layers,
      title: "Glaucoma Treatment in Bangalore for Filipino Patients",
    ...
    {
      icon: Shield,
      title: "Cornea Treatment in Bangalore for Filipino Patients",
    ...
    {
      icon: Baby,
      title: "Pediatric Ophthalmology in Bangalore for Filipino Patients",
    ...
    {
      icon: Smile,
      title: "Squint Eye Treatment in Bangalore for Filipino Patients",
    ...
    {
      icon: Scissors,
      title: "Oculoplasty Treatment in Bangalore for Filipino Patients",
  ...
  const steps = [
    {
      ...
      desc: "Share optical scans or diagnostic files from Manila, Cebu, or Davao via WhatsApp (+91 9739302523) for immediate preliminary evaluation and cost estimation."
    },
    {
      number: "02",
      title: "Medical Visa (V-Visa) Letter",
      desc: "Priority Medical Visa Invitation Letter prepared within 24 hours for expedited processing through the Embassy of India in Manila."
    },
    {
      number: "03",
    ...
    },
    {
      ...
      desc: "Undergo painless daycare microsurgery, receive a fit-to-fly certificate, and continue post-op virtual tele-consultations back home in the Philippines."
    }
  ];

  const faqs = [
    {
      q: "How do I get an Indian Medical Visa from Manila?",
      a: "Upon reviewing your optical scans and passport copies via WhatsApp or email, our international desk issues an authorized hospital Medical Visa Invitation Letter within 24 hours for expedited processing at the Embassy of India in Manila."
    },
    {
      q: "What is the advantage of getting cataract surgery at Vijaya Eye Clinic?",
      a: "Filipino patients receive stitchless micro-incision phacoemulsification with advanced premium lenses (Monofocal, Multifocal, Toric) from top global brands like Zeiss and Alcon, delivering 60% to 75% savings compared to private regional healthcare."
    },
    {
      q: "Will I face any communication issues at the hospital?",
      a: "No. English is the primary medium of consultation across our entire clinical staff, operating surgeons, and international patient care coordinators."
    },
    {
      q: "Can I travel alone, or should I bring a companion?",
      a: "Our hospital team provides comprehensive on-site logistics and bedside care. You are welcome to travel alone, or bring family companions for whom we arrange comfortable serviced apartments."
    },
    {
      q: "What are the accepted methods of payment for international health packages?",
      a: "Packages are presented transparently in USD/INR to avoid currency volatility. We accept international bank wire transfers, major credit cards, and foreign currency exchange."
    },
    {
      q: "How do I handle post-operative updates once I return to the Philippines?",
      a: "We maintain ongoing connectivity through dedicated tele-health channels for scheduled virtual follow-up evaluations via Zoom or WhatsApp directly with your operating surgeon."
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Best Eye Hospital in Bangalore for Filipino Patients | Vijaya Eye Clinic</title>
        <meta
          name="description"
          content="Premium eye surgery in Bangalore, India for patients from the Philippines (Manila, Cebu). Advanced eye surgery in india from manila, cataract, LASIK, retina & cornea care at Vijaya Eye Clinic."
        />
        {/* Combined Keywords: Original + All 8 Core Procedures */}
        <meta
          name="keywords"
          content="best eye hospital in bangalore for filipino patients, advanced eye surgery in india from manila, cataract surgery bangalore vijaya eye clinic, premium lasik cost india philippines, cataract surgery in bangalore for filipino patients, lasik surgery in bangalore for filipino patients, retina treatment in bangalore for filipino patients, cornea treatment in bangalore for filipino patients, glaucoma treatment in bangalore for filipino patients, pediatric ophthalmology in bangalore for filipino patients, squint eye treatment in bangalore for filipino patients, oculoplasty treatment in bangalore for filipino patients"
        />

        {/* Canonical Link */}
        <link rel="canonical" href="https://vijayaeyeclinic.com/international/philippines" />
        ...
        <script type="application/ld+json">
          {JSON.stringify(philippinesSchema)}
        </script>
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <section className="relative min-h-[640px] flex items-center justify-center bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <span className="inline-flex items-center gap-2 bg-blue-500/20 text-blue-300 text-sm font-semibold px-4 py-1.5 rounded-full mb-6 border border-blue-400/30">
              <Plane className="w-4 h-4" /> Philippines to Bangalore Medical Care Concierge
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Best Eye Hospital in Bangalore for Filipino Patients
            </h1>
            <p className="text-lg md:text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
              Seeking advanced eye surgery in india from manila, Cebu, or Davao? Vijaya Eye Clinic provides world-class surgical care, blade-free LASIK, and vitreoretinal treatments with comprehensive visa assistance.
            </p>
        ...
        <section className="py-14 px-4 bg-white border-b border-slate-100">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-700 leading-relaxed text-base md:text-lg">
              Every year, patients and families from the Philippines travel to <strong>Vijaya Eye Clinic</strong> across our state-of-the-art super specialty facilities in <strong>Vijayanagar</strong> and <strong>Nagadevanahalli</strong>, Bangalore. With over 35 years of clinical trust, we deliver the same US-FDA approved technologies used in leading Western centers at predictable, cost-effective pricing.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2">
                Advanced Eye Treatments for Filipino Patients
              </h2>
        ...
        {/* Why Patients from the Philippines Choose Us */}
        <section className="py-20 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2">
                Why Filipino Patients Choose Vijaya Eye Clinic
              </h2>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-50 to-blue-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2">
                Your Journey from the Philippines to Bangalore
              </h2>
            </div>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-blue-50/80 p-8 rounded-2xl border border-blue-200">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Dedicated Hospitality for Filipino Families</h3>
          ...
          <div className="container mx-auto max-w-3xl">
            <div className="text-center mb-14">
              ...
              <p className="text-slate-600">
                Essential travel and treatment details for Filipino residents planning eye care in Bangalore.
              </p>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
              Send your prescription and optical reports from Manila, Cebu, or Davao for an expert surgical evaluation, doctor recommendation, and transparent quote.
            </p>
            ...
            <div className="bg-blue-800/60 border border-blue-400/30 p-8 rounded-2xl">
              <h3 className="text-xl font-bold mb-6">Philippines Patient Coordination Desk</h3>
