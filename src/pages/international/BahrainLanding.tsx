...
const BahrainLanding = () => {
  ...
  const advantages = [
    ...
    { icon: Award, title: "40+ Years Excellence", desc: "Trusted expertise and world-class outcomes" },
  ];
  ...
  const steps = [
    ...
    { number: "02", title: "Medical Visa Invitation", desc: "Swift processing through Indian Embassy" },
  ...
  const faqs = [
    ...
    {
      q: "Can you arrange flights from Manama?",
      a: "Yes, direct flights from Bahrain International Airport to Bangalore."
    },
    {
      q: "What payment options are available?",
      a: "Multiple currencies with transparent USD/INR pricing."
    },
    {
      q: "Is accommodation provided?",
      a: "Premium serviced apartments with kitchens."
    },
    {
      q: "What post-operative support is available?",
      a: "Full monitoring through virtual consultations."
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Best Eye Hospital in Bangalore for Bahraini Patients | Vijaya Eye Clinic</title>
        <meta name="description" content="Premium, world-class eye surgery in Bangalore, India for patients from Bahrain (Manama, Riffa). Advanced Cataract, LASIK, and Retinal care at Vijaya Eye Clinic. Get a rapid medical visa invite." />
        <meta name="keywords" content="best eye hospital in bangalore for bahraini patients, advanced eye surgery in india from manama, cataract surgery bangalore vijaya eye clinic, premium lasik cost india bahrain" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        <section className="relative min-h-[600px] flex items-center justify-center bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Premium Eye Care for Patients from Bahrain</h1>
            <p className="text-lg md:text-xl text-blue-100 mb-8">From Manama, Riffa, Muharraq seeking vision restoration.</p>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-700">Our facilities in <strong>Vijayanagar</strong> and <strong>Nagadevanahalli</strong> offer world-class care.</p>
          </div>
        </section>

        <section className="py-16 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Why Bahraini Patients Choose Vijaya Eye Clinic</h2>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Your Journey from Bahrain</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {steps.map((step, idx) => (
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-100 mb-8">Join Bahraini patients for world-class care.</p>
