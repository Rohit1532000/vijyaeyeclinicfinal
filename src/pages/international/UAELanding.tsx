...
const UAELanding = () => {
  ...
  const advantages = [
    ...
    { icon: Users, title: "Direct Flight Connectivity", desc: "Daily flights from Dubai (DXB) and Abu Dhabi (AUH) to Bangalore within hours" },
  ...
  const steps = [
    ...
    { number: "02", title: "Medical Visa Invitation", desc: "Official invitation letter to Indian Embassy in Abu Dhabi or Dubai" },
  ...
  const faqs = [
    {
      ...
      a: "Most procedures require 4-6 days including diagnostics and initial recovery. Your quick turnaround is important to us."
    },
    {
      q: "Can you arrange flights from Dubai or Abu Dhabi?",
      a: "Yes, direct flights from DXB and AUH to BLR are available daily. Our team coordinates everything seamlessly."
    },
    {
      q: "What payment options are available for UAE residents?",
      a: "We accept multiple currencies with transparent pricing locked in USD/INR for budget certainty."
    },
    {
      q: "Is accommodation included in treatment packages?",
      a: "We arrange premium serviced apartments with kitchens near our facilities for your comfort."
    },
    {
      q: "What post-operative support is available after returning to UAE?",
      a: "Full post-operative monitoring through virtual consultations and WhatsApp to ensure smooth recovery."
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Elite, high-tech eye surgery in Bangalore, India for patients from the UAE (Dubai, Abu Dhabi, Sharjah). Advanced Cataract, LASIK, and Retinal care at Vijaya Eye Clinic. Get a rapid medical visa invite." />
        <meta name="keywords" content="best eye hospital in bangalore for uae patients, advanced eye surgery in india from dubai, cataract surgery bangalore vijaya eye clinic, premium lasik cost india uae" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        <section className="relative min-h-[600px] flex items-center justify-center bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white px-4 py-20">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Premium Eye Care for Patients from the UAE</h1>
            <p className="text-lg md:text-xl text-blue-100 mb-8">From Dubai, Abu Dhabi, and Sharjah seeking elite vision restoration.</p>
        ...
        <section className="py-16 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Why UAE Patients Choose Vijaya Eye Clinic</h2>
        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Your Journey from UAE</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {steps.map((step, idx) => (
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready for Elite Eye Care?</h2>
            <p className="text-lg text-blue-100 mb-8">Join UAE patients who chose Vijaya Eye Clinic for world-class vision restoration.</p>
